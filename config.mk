...
$(INDEX_FILE): $(SOURCE_DIR)/src/index-pages.py $(SCRIPTS_DIR)/gnu/index-terms-colon.py $(DOCUMENTS_DIR)
	...
	$(SCRIPTS_DIR)/gnu/index-terms-colon.py "Function" $@ $(DOCUMENTS_DIR)/Index-of-Functions-and-Macros.html
	$(SCRIPTS_DIR)/gnu/index-terms-colon.py "Variable" $@ $(DOCUMENTS_DIR)/Index-of-Variables.html
	$(SCRIPTS_DIR)/gnu/index-terms-colon.py "Type"     $@ $(DOCUMENTS_DIR)/Index-of-Data-Types.html
	$(SCRIPTS_DIR)/gnu/index-terms-colon.py "Hook"     $@ $(DOCUMENTS_DIR)/Index-of-Hooks.html
	$(SCRIPTS_DIR)/gnu/index-terms-colon.py "Option"   $@ $(DOCUMENTS_DIR)/Index-of-Scanner-Options.html
